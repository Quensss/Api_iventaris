...
export default function Table({ dataTh, dataTd, coloumDB, buttonData, endpoints, columDetail, judulModalEdit, inputData, h }) {
    ...
    return (
        <>
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg px-6  py-20">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        ...
                                        }
                                        {
                                            buttonData.includes("restore") ? (
                                                <a href="" onClick={() => handleRestore(value.id)} class="font-medium text-green-600 dark:text-green-500 hover:underline">restore</a>
                                            ) : ""
                                        }
                                        {
