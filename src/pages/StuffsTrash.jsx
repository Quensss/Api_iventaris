...
export default function StuffTrash() {
    ...
    return(
      ...
      <div className="flex justify-between items-center mt-10">
        <Link to={'/stuffs'} className="ml-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-black-700 dark:focus:ring-red-800">Back</Link>
        <Navbar />
      </div>
      <Table
        dataTh={dataThParent}
